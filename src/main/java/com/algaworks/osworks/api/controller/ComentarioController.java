...
public class ComentarioController {
	...
	@Autowired private GestaoOrdemServicoService gestaoOrdemServico;
	...
	private List<ComentarioModel> listar(@PathVariable Long ordemServicoId){
		OrdemServico ordemServico = ordemServicoRepository.findById(ordemServicoId).orElseThrow(() -> new EntidadeNaoEncontradaException("Ordem de serviço não encotrada."));
